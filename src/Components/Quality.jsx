...
gsap.registerPlugin(ScrollTrigger)
  ...
  return (
    <>
    <div className='cont-4 w-full h-[110vh] flex flex-row  xl:flex lg:flex md:flex'>
      ...
      <div className="right-1-4 w-[50%] pt-15 overflow-hidden flex flex-col items-center">
