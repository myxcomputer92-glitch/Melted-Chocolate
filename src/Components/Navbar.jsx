...
const Navbar = () => {
 ...
 <nav className='w-full sticky top-0 z-50 overflow-hidden flex justify-center shrink-0 xl:gap-8 p-7 xl:justify-center lg:justify-between md:justify-between'>
    <div className="div-1 flex gap-2 bg-white h-22 border-2 border-white rounded-lg xl:w-212.5 xl:h-18 lg:w-177.5 lg:h-22 md:w-132.5 md:h-18 md:gap-0"> 
    ...
    <div className="contain-li p-6 flex gap-10 items-start text-nowrap text-2xl list-none xl:gap-10 lg:gap-10 md:gap-5 lg:text-xl md:text-sm">
      <li className='hover:cursor-pointer'>Flavor's</li>
      <li className='hover:cursor-pointer'>Our story</li>
      <li className='hover:cursor-pointer'>How it's made</li>
      <li className='hover:cursor-pointer flex justify-between items-start gap-0'>Gifting <img className='transform xl:w-15 xl:-translate-y-7 xl:h-16 lg:w-15 lg:-translate-y-5 lg:h-15 md:w-10 md:-translate-y-4 md:h-10 ' src="/assets/images/colored-gift.gif" alt="Gift" /></li>
    </div>
  </div>
   <div className="div-2 bg-white h-22 w-78 p-5 text-nowrap border-2 border-white rounded-lg xl:w-68 xl:h-18 xl:p-5 lg:p-6 lg:w-60 lg:h-22 md:w-46 md:h-18 md:p-6">
     <li className='flex gap-6 text-2xl xl:text-2xl lg:text-xl md:text-sm xl:gap-6 lg:gap-6 md:gap-2'>Explore Flavors
